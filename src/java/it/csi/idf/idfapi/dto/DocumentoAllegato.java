...
public class DocumentoAllegato {
	...
	private Integer fkTipoAleggato;
	...
	public Integer getFkTipoAleggato() {
		return fkTipoAleggato;
	}
	public void setFkTipoAleggato(Integer fkTipoAleggato) {
		this.fkTipoAleggato = fkTipoAleggato;
	}
