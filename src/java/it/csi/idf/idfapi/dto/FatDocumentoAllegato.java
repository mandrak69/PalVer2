...
public class FatDocumentoAllegato {
	...
	private Integer idTipoAleggato;
	...
	public Integer getIdTipoAleggato() {
		return idTipoAleggato;
	}
	public void setIdTipoAleggato(Integer idTipoAleggato) {
		this.idTipoAleggato = idTipoAleggato;
	}
