...
public class InterventoCatforDAOImpl implements InterventoCatforDAO {
	...
	public int insertInterventoCatfor(InterventoCatfor interventoCatfor) {
		...
		parameters.add(interventoCatfor.getDataInserimento() == null ? null : Date.valueOf(interventoCatfor.getDataInserimento()));
		parameters.add(interventoCatfor.getDataAggiornamento() == null ? null : Date.valueOf(interventoCatfor.getDataAggiornamento()));
