...
public class AdsrelSpecieDAOImpl implements AdsrelSpecieDAO {
	...
	@Override
	public List<RAdsrelSpecie> searchByCodiceADS(String codiceADS) {
	...
	public int saveAdsrelSpecieCAV(RAdsrelSpecie radsrelSpecie) {
		...
		sql.append(" data_inizio_validita, idgeo_pt_ads, flg_pollone_seme) ");
		sql.append("VALUES(?,?,?,?,?,?,?)");
	...
	public int saveAdsrelSpecieForRelascopica(RAdsrelSpecie plainAdsrelSpecie, Long codiceAds) {
		...
		sql.append(" nr_alberi_pollone, note, data_inizio_validita, cod_tipo_campione, diametro, flg_pollone_seme, altezza, incremento )");
		sql.append("VALUES(?,?,?,?,?,?,?,?,?,?,?)");
	...
	public int saveAdsrelSpecieAlberi(PlainAdsrelSpecie plainAdsrelSpecie, String codiceAds, Integer idSpecie) {
        ...
        return AIKeyHolderUtil.updateWithGenKey("idSpecie", sql.toString(), parameters);
	}
